...
csound -3 -A -o Boulanger_Trapped.aif
...
; global vloume control: desired max over observed max with givol = 1.0
givol = 32000/38500
;==============================================================================; 
;================================== INSTRUMENTS ===============================;
;==============================================================================; 
...
a11    oscil    k18, ((ifreq + .001) + k17) * aglis, 13, 1.3
       ...
       outs     givol * (a1 + a3 + a5), givol * (a7 + a9 + a11)
       endin
;==============================================================================; 
;==================================== BLUE ====================================;
;==============================================================================; 
...
a2     oscil   k3, ifreq + k2, 15
       ...
       outs   givol * ((a1 * .8) + a2), givol * ((a1 * .6) + (a2 * .7))
garvb  =      garvb + (a2 * p10)
       endin
;==============================================================================; 
;==================================== GREEN ===================================;
...
kpan   linseg  int(p8), p3 * .7, frac(p8), p3 * .3, int(p8)
       outs    givol * amix * kpan, givol * amix * (1 - kpan)
garvb  =       garvb + (amix * p7)
       endin
;==============================================================================; 
;================================== COPPER ====================================;
...
a3     oscil   kenv1, cpsoct(ifreq + k3) + aflt * .8, 1
       ...
       outs    givol * a3,givol * ((a3 * .98) + (aflt * .3))
...
a6     oscil   k18, cpsoct((ifreq + .001) + k17), 8, .1
       ...
       outs    givol * (a1 + a3 + a5), givol * (a2 + a4 + a6)
       endin
;==============================================================================; 
;==================================== SMEAR ===================================;
;==============================================================================; 
...
asig   reverb  garvb, 2.1
       outs    givol * asig * k2, givol * (asig * k3) * (-1)
garvb  =       0
       endin
;==============================================================================; 
;==============================================================================; 
